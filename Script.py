...
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/MJ_search_bot> ᴍᴊ ꜱᴇᴀʀᴄʜ ʙᴏᴛ</a>
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/MJHitz)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ..."""

    TOP_ALRT_MSG = """Cʜᴇᴄᴋɪɴɢ Fᴏʀ Mᴏᴠɪᴇ Iɴ Dᴀᴛᴀʙᴀsᴇ..."""

    MELCOW_ENG = """<b>Hᴇʟʟᴏ {} 😍,\nAɴᴅ Wᴇʟᴄᴏᴍᴇ Tᴏ {} Oᴜʀ Gʀᴏᴜᴘ ❤️</b>"""
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த MJ search Bot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this MJ search Bot bot to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ MJ search bot బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस MJ search bot बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ MJ search bot ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس MJ search bot بوٹ کا انتظام کریں۔
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ MJ search bot ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
 ...
 EXP: /set_tutorial ವೀಡಿಯೊ ಲಿಂಕ್

ನಿಮ್ಮ ತಂಡಕ್ಕೆ, ವೀಡಿಯೋ ತರಬೇತಿ ನೀಡಲಿದೆ..."""
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই MJ search bot বট পরিচালনা করুন
