...
URL = "https://mj-test.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mj-test.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mj-test.onrender.com/".format(FQDN)
else:
    URL = "https://mj-test.onrender.com/".format(FQDN)
