...
from info import ADMINS, YT_ADMINS

@Client.on_message(filters.command(['song', 'mp3']) & filters.user(YT_ADMINS))
...
@Client.on_message(filters.command(["video", "mp4"]) & filters.user(YT_ADMINS))
